...
class Config:
    ...
    vposer_expr_dir =  osp.join(root_dir, 'common', 'nets', 'vposer_v2_05')
    smplx_model_dir =  osp.join(root_dir, 'common', 'nets', 'body_model','smplx','nature','SMPLX_NEUTRAL_2020.npz')
    smpl_model_dir  =  osp.join(root_dir, 'common', 'nets', 'body_model','smpl','nature','model.npz')    
...
sys.path.insert(0, osp.join(cfg.root_dir, 'vposer'))
