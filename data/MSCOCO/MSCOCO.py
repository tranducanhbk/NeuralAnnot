...
from utils.postprocessing import transform_human_model_parameter_to_2d_image, transform_human_model_parameter_to_2d_image11
        ...
        if self.data_split == 'train':
            ...
            for aid in db.anns.keys():
                ...
                if cfg.parts == 'body':
                    ...
                    data_dict = {'img_path': img_path, 'img_shape': (img['height'],img['width']), 'bbox': bbox, 'joint_img': joint_img, 'joint_valid': joint_valid}  
                ...
                # hand part
                    ...
                    for hand_type in ('left', 'right'):
                        ...
                        data_dict = {'img_path': img_path, 'img_shape': (img['height'],img['width']), 'bbox': bbox, 'joint_img': joint_img, 'joint_valid': joint_valid, 'hand_type': hand_type}
                        datalist.append(data_dict)
    ...
    def __getitem__(self, idx):
        ...
        if self.data_split == 'train':
            ...
            if cfg.parts == 'body':
                # affine transform
                bbox = data['bbox']
                img, img2bb_trans, bb2img_trans, rot, do_flip = augmentation(img, bbox, 'val') # self.data_split)
                ...
                inputs = {'img': img}
                targets = {'joint_img': joint_img, 'joint_cam': joint_cam}
                meta_info = {'joint_valid': joint_valid, 'joint_trunc': joint_trunc, 'is_3D': float(False)}
